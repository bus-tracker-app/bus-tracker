...
import type { VehicleJourneyPosition } from "@bus-tracker/contracts/vehicle-journey";
...
export class Journey {
	...
	guessPosition(at: Temporal.Instant): VehicleJourneyPosition {
		...
		return {
			...
			atStop: false,
			type: "COMPUTED",
			recordedAt: at.toZonedDateTimeISO(monitoredCall.aimedArrivalTime.timeZoneId).toString({ timeZoneName: "never" }),
		};
	}
